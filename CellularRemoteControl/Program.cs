...
namespace CellularRemoteControl
{
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            if (!Directory.Exists(@"SD\Temp"))
            {
                Directory.CreateDirectory(@"SD\Temp");
            }
            if (!Directory.Exists(@"SD\Settings"))
            {
                Directory.CreateDirectory(@"SD\Settings");
            }
            if (!Directory.Exists(@"SD\ReceivedSMS"))
            {
                Directory.CreateDirectory(@"SD\ReceivedSMS");
            }
            if (!Directory.Exists(@"SD\Web"))
            {
                Directory.CreateDirectory(@"SD\Web");
            }
